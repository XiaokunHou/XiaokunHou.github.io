...
In Dicembre 2019, il collettivo di hackers *Anonymous Italia* attacca le piattorme informatiche di alcuni atenei Italiani, riesce ad ottenere dei dati personali degli utenti ed li pubblica in rete. Questi dati includono ID, emails, passaporti, passwords e qualifiche di docenti e studenti. Nel rivendicare l'atto, il collettivo spiega che esso è stato una denuncia contro la scarsa sicurezza delle piattaforme che custodiscono i dati universitari, un atto di protesta che richiama l'attenzione sugli enormi tagli subiti dal sistema educativo italiano. In fondo - spiega il collettivo - la scarsa sicurezza delle piattaforme significava che questi dati erano in qualche misura già pubblici. Almeno ora ve ne era consapevolezza.

Come reagireste in risposta ad una situazione del genere? La ritenete giusta? Ad esemplificare il raggio di possibili reazioni, ecco due risposte tratte dai commenti al loro [blog](https://anonitaly.blackblogs.org/2019/12/22/cervelli-in-fuga/). 
...
Queste risposte sottolineano l'inerente ambiguità di questi atti. È difficile giudicarne motivazioni ed effetti. Abbiamo analizzato la questione in una ricerca empirica recente, che ha indagato come le persone giudicano atti come questo, e le cause psicologiche di questi giudizi.
...
Gli hackers, in molti aspetti, hanno caratteristiche simili a quelle dei banditi descritti da Hobsbawm. Come i banditi, le loro azioni - si diceva prima - sono inerentemente ambigue: agiscono per il loro rendiconto o per noi? Come i banditi, gli hackers operano in territori difficili da controllare per l'autorità (le periferie dei regni, o internet). E come i banditi hanno accesso a risorse e competenze che non tutti nella popolazione generale hanno.

### Lo studio empirico

In questo studio, con due esperimenti che hanno coinvolto circa 480 partecipanti, abbiamo analizzato la relazione fra efficacia politica (avere voce) e la legittimazione degli hackers. I due esperimenti sono molto simili, e replicano lo stesso fenomeno in due contesti diversi (nel contesto universitario e nella popolazione generale). Qui descrivo solo uno dei due studi, ma i risultati sono equivalenti. 

Nello studi, i participanti vengono posti di fronte una situazione di ingiustizia. Ad esempio, agli studenti di uno degli studi viene descritta una situazione in cui essi ricevono un voto iniquo ad un esame, e portano le loro rimostranze ad un ufficio amministrativo dell'università.
...
Ad entrambi i gruppi viene poi chiesto in che misura essi si sentono arrabbiati contro l'università (la nostra misura di rabbia contro il sistema). Infine, a tutti i partecipanti viene descritto l'accadamimento un attacco hacker ai danni dei sistemi informatici universitari e viene misura la legittimazione di questo attacco utilizzando sei items che misurano l'accordo o il disaccordo con delle affermazioni (ad esempio, "le azioni degli hackers sono legittime").

L'esperimento, quindi, manipola sistematicamente i sentimenti di efficacia politica nei partecipanti. Un gruppo viene esposto ad una situazione di bassa efficacia, l'altro di alta efficacia. Successivamente, vengono misurate le conseguenze di questa manipolazione in entrambi i gruppi e le medie comparate.
...
Le persone che sentono bassi livelli di efficacia politica provano più rabbia rispetto l'ingiustiza subita (che è identica in entrambe le condizioni) e legittimano l'attacco hacker in misura statisticamente maggiore dell'altro gruppo. 
...
Questo studio inizia ad illuminare alcuni dei processi psicologici alla base dell'ammirazione degli hackers. Si tratta delle prime evidenze sperimentali del ruolo dell'efficacia politica nella percezione. In linea con quanto avevamo ipotizzato, quando le persone percepiscono di avere poca voce e bassa efficacia, essere possono reagire mostrando maggiore rabbia contro il sistema, una rabbia che poi è associata ad una maggiore ammirazione verso gruppi che attacano tale sistema.

Una questione importante da chiarie è che non è necessario che gli hackers (o i banditi in genere) stiano agendo **realmente** per conto delle persone, o a loro beneficio. Nell'esperimento - così come nella vita reale mimata nella situazione sperimentale - noi sappiamo poco delle motivazioni vere degli hackers. Ciò che forse conta di più - ed abbiamo in programma altri studi per esaminre la questione - è la capacità degli hackers di incarnare, tramize azioni clamorose e altamente visibili, la rabbia degli individui contro un sistema ritenuto ingiusto e altrimenti impossibile da cambiare.

Sono i banditi davvero quello che dicono di essere? Raramente lo sappiamo. Il fenomeno è più ampio degli hackers - ed esistono vari gruppi in società che tentano di ottenere quel tipo di consenso. La questione è stata anche oggetto di un dibattito estramente interessante tra il sociologo Hobsbawm e l'antropologo Blok negli anni '70. Il fulcro del dibattito è: sono i banditi davvero i difensori dei più deboli, incarnando le istanze di coloro che non hanno voce, oppure sono individui egoisti (e spesso violenti) che si approfittano della situazione ai danni *soprattutto* di coloro che non hanno potere. 

La questione è fondamentale dal punto di vista sociologico e irrisolta. Ma dal punto di vista psicologico la questione diviene quasi irrelevante dato che ciò che conta non è l'ontologia del gruppo (ciò che il gruppo è) ma la maniera in cui il gruppo viene percepito dalle persone. Ci sono contesti - la mafia - in cui la lotta è ancora in corso. 
